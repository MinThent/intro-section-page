...
export default function ({ handleToggleSidebar, toggleSidebar }) {
  const [isOpen, setIsOpen] = useState(false);
  return (
    <nav className="p-5">
      <div className="flex flex-row">
        <div>
          <svg width="84" height="27" xmlns="http://www.w3.org/2000/svg"></svg>
        </div>
        {toggleSidebar && (
          <div className="top-0 right-0 fixed flex flex-col items-center gap-8 md:hidden bg-white p-5 w-64 h-full">
            <div
            ...
            <div className="flex flex-col gap-5 mr-auto">
              ...
              {isOpen && (
                <div className="flex flex-col gap-4 ml-auto pl-5">
